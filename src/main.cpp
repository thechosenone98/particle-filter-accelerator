            ...
            if(cmd==0){
                ...
                for(particle_index = 0; particle_index < NUM_PARTICLES * nb_scans; particle_index++){
                    ...
                    for (i1 = 0; i1 < 400; i1++){
                        ...
                        int32_t distance1 = (int32_t)(distance_x1 * distance_x1) + (int32_t)(distance_y1 * distance_y1);
                        int32_t distance2 = (int32_t)(distance_x2 * distance_x2) + (int32_t)(distance_y2 * distance_y2);
